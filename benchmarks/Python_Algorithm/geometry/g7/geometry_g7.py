...
def main(size: str) -> None:
    ...
    if size == "small":
        ...
        # G7: Usar una operación masiva (list comprehension) para crear la lista de
        # objetos, lo que reduce la sobrecarga de las llamadas repetidas a .append().
        ...
        # objetos, lo que reduce la sobrecarga de las llamadas repetidas a .append().
        shapes = [
            Rectangle(short_side_length=i * 0.01, long_side_length=i * 0.02)
