...
def run_genetic_algorithm(target: str, genes: list[str], debug: bool = True) -> tuple[int, int, str]:
    ...
    # G1: Assign the result of len(target) to a variable to avoid re-computation.
    ...
    while True:
        ...
        # G1: Assign the best result to variables to avoid multiple lookups.
        best_string, best_score = population_score[0]
        ...
        if debug and generation % 10 == 0:
            print(
                ...
                f"\nBest score: {best_score}/{target_len}"
